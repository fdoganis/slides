...
| ![Needle Go](https://www.google.com/s2/favicons?sz=64&domain_url=https://engine.needle.tools) | [Needle Go (Needle App Clip)](https://apps.apple.com/us/app/needle-go/id6757205152) | ⚠️ (no License) | ✅| `https://appclip.needle.tools/?url=<url>` | [**Free to use + works with vanilla three.js**](https://engine.needle.tools/docs/how-to-guides/xr/ios-webxr-app-clip.html) ⭐️ | Licensing for commercial usage |
